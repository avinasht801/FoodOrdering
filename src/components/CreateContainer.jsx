      ...
      <div className='w-[90%] md:w-[75%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        {
          fields && (
            <motion.p initial={{ opacity: 0 }}
              ...
              className={`w-full p-2 rounded-lg text-center ${alertStatus === "danger" ? 'bg-red-400 text-red-900' : 'bg-emerald-400 text-emerald-800'}`}>
              {msg}
            </motion.p>
          )
        }
        <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
          ...
          <input type='text' required onChange={(e) => setTitle(e.target.value)} value={title} placeholder='Please provide the title' className='w-full h-full text-lg bg-transparent outline-none border-none placeholder:text-gray-400 text-textColor' />
        </div>
        ...
        <div className='w-full flex flex-col md:flex-row items-center gap-3'>
          <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
            <PiCurrencyGbpFill className='text-gray-700 text-2xl' />
